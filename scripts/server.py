...
if __name__ == "__main__":
    ...
    if n_subjects > 10:
        ...
        print('Minimum no. of subjects available is: 1')
        exit()

    if n_books > 5:
        print('Maximum no. of books available for each subject is: 5')
        exit()
    elif n_books < 1:
        print('Minimum no. of books available for each subject is: 1')
        exit()
